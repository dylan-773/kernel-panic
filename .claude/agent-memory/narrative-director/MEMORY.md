...
- [Artifact voice vs benchNote split](artifact-voice-vs-benchnote-split.md) — a document body may only say what its diegetic source could know; comparisons/reactions go in benchNote, not the printed artifact
- [Diegetic cadence claims need checking](diegetic-cadence-claims-need-checking.md) — a specific mechanic-cadence line (per-dive vs per-run) must be checked against the reducer, not just written more concretely
