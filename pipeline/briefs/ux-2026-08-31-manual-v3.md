...
CYCLE CLOSED 2026-09-08 (orchestrator): the demo reached `awaiting` on 2026-08-31 and was never approved; the pixel desktop rebuild of 2026-09-04 restyled MANUAL.TXT directly, so the demo is archived as superseded in `ui-demos/manifest.json`.
