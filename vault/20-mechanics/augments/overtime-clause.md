...
**Boost** · `overtimeClause`

> Cap wins pay 75 percent of the ticket instead of 50. The client eats every hour past the deadline, not half.

`jobPayFor(run, capWin)` multiplies by 0.75 rather than 0.5.
